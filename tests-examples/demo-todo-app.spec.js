...
<<<<<<< HEAD
    ...
    test_1.test.afterEach((_b) => __awaiter(void 0, [_b], void 0, function* ({ page }) {
        yield checkNumberOfTodosInLocalStorage(page, 3);
    }));
...
<<<<<<< HEAD
    ...
    (0, test_1.test)('should display the correct text', (_b) => __awaiter(void 0, [_b], void 0, function* ({ page }) {
